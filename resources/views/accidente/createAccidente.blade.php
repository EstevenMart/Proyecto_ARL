                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <br>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="laborHabitual"  value="No" @if(old('laborHabitual') == 'No') checked @endif >
                                <label class="form-check-label" >No</label>
                              </div>
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="laborHabitual" value="Si" @if(old('laborHabitual') == 'Si') checked @endif>
                    ...
                    <div class="card-body">
                        <div class="form-group">
                           <div class="section-title mt-0">Tiempo Previo al Accidente</div>
                                <input type="number" class="form-control @error('tiempoPA') is-invalid @enderror" id="tiempoPA" name='tiempoPA' value="{{old('tiempoPA')}}">
                                @error('tiempoPA')
                                <div class="text-danger">
                                    {{ $message }}
                                </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                    ...
                    <div class="card-body">
                        ...
                        <div class="section-title mt-0">Cantidad Horas</div>
                                <input type="number" class="form-control @error('cantHoras') is-invalid @enderror" id="cantHoras" name='cantHoras' value="{{old('cantHoras')}}">
                                @error('cantHoras')
                                <div class="text-danger">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('cantMinutos') is-invalid @enderror" id="cantMinutos" name='cantMinutos' value="{{old('cantMinutos')}}">
                                @error('cantMinutos')
                                <div class="text-danger">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <select class="custom-select @error('tipoaccidente') is-invalid @enderror " name="tipoaccidente" id="tipoaccidente" >
                                        <option value="">Seleccione...</option>
