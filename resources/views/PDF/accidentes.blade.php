...
<nav class="navbar navbar-light bg-light">
    ...
    <center> 
        <div >
            ...
            <img class="imagen" src="https://i.ibb.co/pz4MwLJ/logo1-2.jpg" alt="logo1-2" width="100px" height="50px">
            <br>
              
            {{-- <a href="https://imgbb.com/"><img src="https://i.ibb.co/pz4MwLJ/logo1-2.jpg" alt="logo1-2" border="0"></a> --}}
          </div>
    </center> 
    </a>
  </nav>
  <br><br><br><br>
   <center> <h1 >Tabla de Accidentes</h1></center>
    ...
    <table class="table table-bordered">
            ...
            <nav class="navbar navbar-light bg-light">
                <a class="navbar-brand" href="#">
                <center> 
                     <img src="https://images.vexels.com/media/users/3/141982/isolated/lists/a8799737bfac00f2e9bb444c294351c1-cinta-retro-etiqueta-azul-cielo.png" alt="">
                </center> 
                </a>
              </nav>
...
@import url('https://fonts.googleapis.com/css2?family=Anton&family=Lato:ital,wght@0,400;1,300&family=Open+Sans:wght@300&family=Oswald:wght@500&display=swap');
@font-face {
  font-family: Arbeid;
  src: url(../../public/font/Azonix-1VB0.otf);
}
/* .imagen{
...
.bg-primary {
  background-color: #0c8195 !important; }
...
.imagecheck-figure:before {
  ...
  -ms-user-select: none;
  user-select: none;
  background: #0c8195 url("data:image/svg+xml;charset=utf8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3E%3Cpath fill='%23fff' d='M6.564.75l-3.59 3.612-1.538-1.55L0 4.26 2.974 7.25 8 2.193z'/%3E%3C/svg%3E") no-repeat center center/50% 50%;
  color: #fff;
  z-index: 1;
  border-radius: 3px;
  opacity: 0;
...
.card {
  ...
  .card.card-hero .card-header {
    padding: 40px;
    background-image: linear-gradient(to bottom, #0c8195, #95a0f4);
    color: #fff;
    overflow: hidden;
    height: auto;
    min-height: auto;
...
.btn-primary, .btn-primary.disabled {
  ...
  .btn-primary:focus, .btn-primary.disabled:focus {
    background-color: #086270 !important; }
...
a.bb {
  text-decoration: none;
  border-bottom: 1px solid #0c8195;
  padding-bottom: 1px; }
...
@-webkit-keyframes pulsate {
  ...
  100% {
    ...
    opacity: 0.0; } }
 /*boton*/
 .profile-widget-header .media-cta{
   margin-top: 15px;
   margin-right: 30px;
 }
/*Avatar*/
td .profile-widget .profile-widget-picture{
...
.form-control, .input-group-text, .custom-select, .custom-file-label:enabled {
  border-color: #6c757d !important;
}
/* ::selection {
  background: #f35b3f;
...
.form-control[readonly]:hover {
  border: #0c8195 1.5px solid!important;
  cursor: default;
  box-shadow: 1.5px 1.5px  #0c809546;
}
/* ffa426 */
body{
