                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        <div class="card-body">
                            <div class="form-group">
                              ...
                              <input id="password" placeholder="Ingrese su contraseña" type="hidden" class="form-control @error('password') is-invalid @enderror" name="password"  autocomplete="new-password">
                              <input id="password-confirm" placeholder="Confirmar contraseña" type="hidden" class="form-control" name="password_confirmation"  autocomplete="new-password">
